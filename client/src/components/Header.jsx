...
const Header = () => {
  ...
  return (
    <div className='flex flex-col items-center mt-20 px-6 text-center text-gray-800'>
        ...
        <p className='mb-6 mx-w-md'>Let's satart with a quick product tour and we will have you up and running in no time!</p>
        <button className='border border-gray-500 rounded-full px-8 py-2 hover:bg-amber-600 hover:text-white cursor-pointer'>Get Started</button>
    </div>
  )
}
